...
<body>
	<table style="width: 100%;">
		...
		<tr>
			<td>总金额： <c:out escapeXml="Y"
					value="<input type='text' value='${sessionScope.claim.totalAccount }'/>"></c:out>
			</td>
	...
	<table style="width: 100%;margin-bottom: 15px;">
		...
		<c:forEach var="detail"
			...
			<tr>
				<td><c:out value="${detail.item }"></c:out></td>
				<td><c:out value="${detail.account }"></c:out></td>
				<td><c:out value="${detail.des }"></c:out></td>
			</tr>
		</c:forEach>
		<tr>
			<td><select name="type">
					<option value="0">--请选择--</option>
					<option value="1">--礼物费--</option>
					<option value="2">--城市交通费--</option>
			</select><font color="red">*</font></td>
			<td><input type="text" name="price" /><font color="red">*</font>
			</td>
			<td><input width="300" height="200"
				type="text" name="description" /><font color="red">*</font></td>
		</tr>
		<tr>
			<td colspan="3"><font color="red">*</font>事由：<input type="text" name="reason" />
			</td>
		</tr>
	</table>
	<hr />
